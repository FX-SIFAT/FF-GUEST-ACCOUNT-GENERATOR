...
rEgIoNlAnG = {
    ...
    "BD": "en", "PK": "ur", "TW": "zh", "EUROPE": "fr", "RU": "ru",
    "NA": "en", "SAC": "es", "BR": "pt", "SG": "ms", "US": "en"
}
...
BD_CARRIERS = [
    "Grameenphone", "Robi", "Banglalink", "Teletalk", "Airtel BD"
]
...
BD_DEVICES = [
    "Xiaomi Redmi Note 11", "Samsung SM-A525F", "Realme 8", 
    "Vivo Y20", "Oppo F19", "OnePlus Nord CE 2", "Tecno Spark 7"
]
...
def nIcE(session, access_token, open_id, region, lang_code):
    ...
    if region.upper() == "BD":
        device_model = random.choice(BD_DEVICES)
